...
def policyImprover(inputPolicy1, inputPolicy2, inputAction1, inputAction2, learningRate, rewardMatrix, firstPlayerPolicyExpect, secondPlayerPolicyExpect, i):
    ...
    inputPolicy2[1-inputAction2] += learningRate*rewardMatrix[inputAction1][inputAction2]*inputPolicy2[1-inputAction2]+ (learningRate/2)*(secondPlayerPolicyExpect[inputAction2 -1] - inputPolicy2[inputAction2 -1])
